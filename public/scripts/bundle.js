...
var FormValidator = function () {
  ...
  _createClass(FormValidator, [{
    ...
    value: function validateOnSubmit() {
      ...
      this.form.addEventListener("submit", function (e) {
        ...
        _this.fields.forEach(function (field) {
          ...
          _this.validateFields(textValue, field); //check to see if input is valid or not
        });
      });
    }
  }, {
    ...
    key: "getResultStatus",
    value: function getResultStatus(outcome, formField, message) {
      var formItemEl = formField.parentElement.parentElement;var errorMessageEl = formItemEl.querySelector("#error_message");
...
var Book = function Book(author, title, totalPages, currentPages, completed) {
  _classCallCheck(this, Book);

  this.title = title, this.author = author, this["total pages"] = totalPages, this["current pages"] = currentPages, this.completed = false;
};
...
var totalPagesEl = document.querySelector("#total_pages");
...
var getMyLibrary = function getMyLibrary() {
  var libraryArrayString = localStorage.getItem("myLibrary");
  try {
...
exports.displayBooks = undefined;
